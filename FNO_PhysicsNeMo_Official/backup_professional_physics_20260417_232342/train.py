...
def get_physics_lambda(epoch, n_epochs):
    """
    Physics lambda = 0.0001 constant.
    Rationale: GNN sweep on same dataset found lambda=0.0001 gave best MAE.
    Higher values (0.002) diverged during pushforward engagement.
