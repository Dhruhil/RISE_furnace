...
class UnifiedDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, h5_path, cfg, split="train", split_mode="training"):
        ...
        # stratified by T_set — deterministic, reproducible
        ...
        # expose the canonical ordering (train first, then val, then test) for normalisation
        ...
        for sim_i in self.sim_indices:
            ...
            for t_i in range(20, t_max - 3):  # FIX: was -2, needs -3 for y3  # -2 for pushforward
        ...
        for gi, sim_i in enumerate(self.sim_indices):
            ...
            for region, rdata in sim["region_data"].items():
                ...
                for i in range(n):
                    for j_local in range(1, k + 1):
                        ...
                        # Forward edge + reverse (bidirectional) + edge type 0=intra
            ...
            # Inter-region boundary edges — ONLY physically adjacent pairs
            # From .geo: heaters+cylinder inside inner_box, inner_box inside outer_box
            VALID_ADJACENCY = {
            ...
            # FIX: Normalise edge distances for training stability
    ...
    def __getitem__(self, idx):
        ...
        # Compute is_heater for node features
        ...
        # ALL 16 node features — future-proof for varying cx/cz/radius/height
