#!/bin/bash
#SBATCH --job-name=3epoch_newphys
#SBATCH --account=NAISS2026-4-712
#SBATCH --partition=alvis
#SBATCH --output=/mimer/NOBACKUP/groups/revar/GNN_Unified/outputs/logs/3epoch_newphys_%j.log
...
apptainer exec --nv --cleanenv \
  ...
  python -u train_unified.py \
    --epochs 3 --lr 3e-4 --lam 0.0001 --batch 2
